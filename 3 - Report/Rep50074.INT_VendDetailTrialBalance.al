report 50074 "INT_Vend Detail Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Rdlc/VendorDetailTrialBalance.rdl';
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            column(ShowRemainingAmt; ShowRemainingAmt)
            {
            }
            dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
            {
                ...
                begin
                    ...
                    if ShowRemainingAmtHaveValue then begin
                        if VendRemainAmount <> 0 then
                            ShowRemainingAmt := true
                        else
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field(ShowRemainingAmtHaveValue; ShowRemainingAmtHaveValue)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Show Remaining Amount Have a Value Only';
                    }
    ...
    var
        ...
        ShowRemainingAmt: Boolean;
        ShowRemainingAmtHaveValue: Boolean;
