page 50092 "INT_Vendor Ledger Entries EDIT"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Vendor Ledger Entries EDIT';
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("AVF_WHT Amount (LCY)"; "AVF_WHT Amount (LCY)")
                {
                    Caption = 'WHT Amount (LCY)';
                    ApplicationArea = Suite;
                    Editable = true;
                    ToolTip = 'Specifies the currency code for the WHT Amount (LCY) on the line.';
                }
