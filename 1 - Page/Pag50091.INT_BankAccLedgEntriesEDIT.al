page 50091 "INT_BankAccLedgEntriesEDIT"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Bank Account Ledger Entries EDIT';
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("FNGN005_Pay-To Description"; "FNGN005_Pay-To Description")
                {
                    Caption = 'Pay-To Description';
                    ApplicationArea = Basic, Suite;
                    Editable = true;
                    ToolTip = 'Specifies the Pay-to Description of the bank account entry.';
                }
