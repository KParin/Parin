page 50101 "INT_Gen. Ledger Entries Update"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("FNAR003_Ref. Cust. Post Date"; "FNAR003_Ref. Cust. Post Date")
                {
                    Editable = true;
                }
                field("FNAR003_Ref. Customer No."; "FNAR003_Ref. Customer No.")
                {
                    Editable = true;
                }
                field("FNAR003_Ref. Custmer Name"; "FNAR003_Ref. Custmer Name")
                {
                    Editable = true;
                }
                field("FNAR003_Ref. Receipt/Tax No."; "FNAR003_Ref. Receipt/Tax No.")
                {
                    Editable = true;
                }
                field("FNAR003_Ref. WHT Type"; "FNAR003_Ref. WHT Type")
                {
                    Editable = true;
                }
                field("FNAR003_Ref. WHT Base"; "FNAR003_Ref. WHT Base")
                {
                    Editable = true;
                }
                field("FNAR003_Ref. WHT%"; "FNAR003_Ref. WHT%")
                {
                    Editable = true;
                }
                field("FNAR003_WHT No. - RV"; "FNAR003_WHT No. - RV")
                {
                    Editable = true;
                }
            }
    ...
    begin
        ...
        DimensionSetEntry.SetRange("Dimension Code", 'JOB ORDER NO.');
        if DimensionSetEntry.FindFirst then
            ShowJobNo := DimensionSetEntry."Dimension Value Code";
    end;
